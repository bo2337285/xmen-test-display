<template>
    <div>
        ...
        <div class="main clear">
            <h3 class="title pre-img-orange">近期新票</h3>
            <div class="lottery-list clear">
                <div v-for="(item,idx) in lotteryList" :key="idx" class="lottery-list-item">
                    <router-link :to="{path:'/hh/lottery-detail',query:{title:item.title,value:item.value,highest:item.highest}}">
            ...
            <h3 class="title pre-img-orange" style="margin-top:64px;">热销票种</h3>
            <div class="lottery-list clear">
                <div v-for="(item,idx) in lotteryList" :key="idx" class="lottery-list-item">
                    <router-link :to="{path:'/hh/lottery-detail'}">
                        <div class="lottery-thumbnail">
                            <img class="lottery-thumbnail-img" width="100%" :src="item.img" />
                        </div>
                        <h3 class="lottery-title">
